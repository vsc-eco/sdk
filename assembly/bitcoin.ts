...
function calcKey(height: i32): string {
  const cs: i32 = 100;
...
function getHeaders(key: string): Map<i64, string> {
...
function extractPrevBlockLE(header: Uint8Array): Uint8Array {
  return header.slice(4, 36);
}

function extractMerkleRootLE(header: Uint8Array): Uint8Array {
 ...
 */
export function validateTxProofWrapper(proof: FullProof): bool {
